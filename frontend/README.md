...
The application uses environment variables for configuration. These are set in the `.env` file:

- `REACT_APP_API_URL`: The URL of the backend API
- `REACT_APP_FIREBASE_*`: Firebase configuration variables

Make sure to update these variables before deployment if needed.
